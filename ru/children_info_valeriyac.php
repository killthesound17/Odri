...
<head>
    ...
    <title>Валерия Ч. - Дети - ODRI Models Management</title>
</head>
...
<body>
    ...
    <div class="container">
      <div class="lang-buttons">
        <a href="../en/children_info_valeriyac.php">EN</a>
        <a href="#">RU</a>
      </div>
    </div>
  <header>
    ...
    <main>
        ...
        <section class="model-profile">
          <div class="model-info">
            <h2 class="model-info__name model-info__name--rus">Валерия Ч.</h2>
            <div class="options">
              ...
              <ul class="option-values">
                <li class="option-values__value">140cm</li>
                <li class="option-values__value">64cm</li>
                <li class="option-values__value">54cm</li>
                <li class="option-values__value">70cm</li>
                <li class="option-values__value">34</li>
                <li class="option-values__value">brown</li>
                <li class="option-values__value">GRAY/BLUE</li>
                <li class="option-values__value">11</li>
              </ul>
            </div>
          </div>
          ...
          <div class="model-slider">
            <div class="model-slide"> <img src="../src/img/children/ValeriiaCh/IMG_9524.jpg" alt="" class="model-slide__photo">  </div>
            <div class="model-slide"> <img src="../src/img/children/ValeriiaCh/IMG_9536.jpg" alt="" class="model-slide__photo">  </div>
            <div class="model-slide"> <img src="../src/img/children/ValeriiaCh/IMG_9569.jpg" alt="" class="model-slide__photo">  </div>
