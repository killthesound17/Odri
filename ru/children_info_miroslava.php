...
<head>
    ...
    <title>Мирослава - Дети - ODRI Models Management</title>
</head>
...
<body>
    ...
    <div class="container">
      <div class="lang-buttons">
        <a href="../en/children_info_miroslava.php">EN</a>
        <a href="#">RU</a>
      </div>
    </div>
  <header>
    ...
    <main>
        ...
        <section class="model-profile">
          <div class="model-info">
            <h2 class="model-info__name model-info__name--rus">Мирослава</h2>
            <div class="options">
          ...
          <div class="model-photos">
            <div class="photos-fullsize">
              <img src="../src/img/children/Miroslava/IMG_1678.jpg" alt="" class="photos-fullsize__photo">
              <img src="../src/img/children/Miroslava/IMG_1734.jpg" alt="" class="photos-fullsize__photo">
              <img src="../src/img/children/Miroslava/IMG_1775.jpg" alt="" class="photos-fullsize__photo">
            </div>
          </div>
          <div class=""></div>
