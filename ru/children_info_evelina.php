...
<head>
    ...
    <title>Эвелина - Дети - ODRI Models Management</title>
</head>
        ...
        <section class="model-profile">
          <div class="model-info">
            ...
            <div class="options">
              ...
              <ul class="option-values">
                <li class="option-values__value">132cm</li>
          ...
          <div class="model-photos">
            ...
            <div class="model-slider">
              <div class="model-slide"> <img src="../src/img/children/evelina/IMG_9961.jpg" alt="" class="model-slide__photo">  </div>
              <div class="model-slide"> <img src="../src/img/children/evelina/IMG_9970.jpg" alt="" class="model-slide__photo">  </div>
              <div class="model-slide"> <img src="../src/img/children/evelina/IMG_9990.jpg" alt="" class="model-slide__photo">  </div>
            </div>
