...
<head>
    ...
    <title>Вероника - Дети - ODRI Models Management</title>
</head>
...
<body>
    ...
    <div class="container">
      <div class="lang-buttons">
        <a href="../en/children_info_veronika.php">EN</a>
        <a href="#">RU</a>
      </div>
    </div>
  <header>
    ...
    <main>
        ...
        <section class="model-profile">
          <div class="model-info">
            <h2 class="model-info__name">Вероника</h2>
            <div class="options">
              ...
              <ul class="option-values">
                ...
                <li class="option-values__value option-values__value--rus">brown</li>
                <li class="option-values__value option-values__value--rus">brown</li>
