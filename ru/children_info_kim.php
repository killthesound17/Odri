...
<head>
    ...
    <title>Ким - Дети - ODRI Models Management</title>
</head>
    ...
    <main>
        ...
        <section class="model-profile">
          <div class="model-info">
            <h2 class="model-info__name">Ким</h2>
            <div class="options">
              ...
              <ul class="option-values">
                <li class="option-values__value">96cm</li>
                <li class="option-values__value">52cm</li>
                <li class="option-values__value">50cm</li>
                <li class="option-values__value">53cm</li>
                <li class="option-values__value">24</li>
                <li class="option-values__value option-values__value--rus">блондин</li>
                <li class="option-values__value option-values__value--rus">голубые</li>
                <li class="option-values__value">4</li>
              </ul>
            </div>
          </div>
          <div class="model-photos">
            ...
            <div class="model-slider">
              <div class="model-slide"> <img src="../src/img/children/Kim/IMG_4901.jpg" alt="" class="model-slide__photo">  </div>
              <div class="model-slide"> <img src="../src/img/children/Kim/IMG_4906.jpg" alt="" class="model-slide__photo">  </div>
              <div class="model-slide"> <img src="../src/img/children/Kim/IMG_4918.jpg" alt="" class="model-slide__photo">  </div>
              <div class="model-slide"> <img src="../src/img/children/Kim/IMG_4929.jpg" alt="" class="model-slide__photo">  </div>
            </div>
