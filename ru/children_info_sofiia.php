...
<head>
    ...
    <title>София - Дети - ODRI Models Management</title>
</head>
...
<body>
    ...
    <div class="container">
      <div class="lang-buttons">
        <a href="../en/children_info_sofiia.php">EN</a>
        <a href="#">RU</a>
      </div>
    </div>
  <header>
    ...
    <main>
        ...
        <section class="model-profile">
          <div class="model-info">
            <h2 class="model-info__name">София</h2>
            <div class="options">
              ...
              <ul class="option-values">
                <li class="option-values__value">106cm</li>
                <li class="option-values__value">54cm</li>
                <li class="option-values__value">50cm</li>
                <li class="option-values__value">56cm</li>
                <li class="option-values__value">28</li>
                <li class="option-values__value option-values__value--rus">blonde</li>
                <li class="option-values__value option-values__value--rus">green</li>
                <li class="option-values__value">5</li>
              </ul>
            </div>
          </div>
          ...
          <div class="model-slider">
            <div class="model-slide"> <img src="../src/img/children/Sofiia/IMG_0789.jpg" alt="" class="model-slide__photo">  </div>
            <div class="model-slide"> <img src="../src/img/children/Sofiia/IMG_0821.jpg" alt="" class="model-slide__photo">  </div>
            <div class="model-slide"> <img src="../src/img/children/Sofiia/IMG_0834.jpg" alt="" class="model-slide__photo">  </div>
