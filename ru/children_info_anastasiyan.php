...
<head>
    ...
    <title>Анастасия Н. - Дети - ODRI Models Management</title>
</head>
...
<body>
    ...
    <div class="container">
      <div class="lang-buttons">
        <a href="../en/children_info_anastasiyan.php">EN</a>
        <a href="#">RU</a>
      </div>
    </div>
  <header>
    ...
    <main>
        ...
        <section class="model-profile">
          <div class="model-info">
            <h2 class="model-info__name model-info__name--rus">Анастасия Н.</h2>
            <div class="options">
          ...
          <div class="model-photos">
            ...
            <div class="model-slider">
              <div class="model-slide"> <img src="../src/img/children/AnastasiiaN/IMG_9661.jpg" alt="" class="model-slide__photo">  </div>
              <div class="model-slide"> <img src="../src/img/children/AnastasiiaN/IMG_9726.jpg" alt="" class="model-slide__photo">  </div>
              <div class="model-slide"> <img src="../src/img/children/AnastasiiaN/IMG_9740.jpg" alt="" class="model-slide__photo">  </div>
            </div>
