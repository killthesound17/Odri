...
<head>
  ...
  <title>ODRI Model Management - Модельное агентство</title>
</head>
<body>
  ...
  <main>
<section class="main-odri">
  <div class="snow"></div>
  <div class="container">
    <div class="wrapper">
    <!-- <div class="main-info">
      <h3 class="main-info__heading">Супер предложение от</h3>
      <h2 class="main-info__odri-heading">"Odri Models"!</h2>
      <p class="main-info__text">Зачем дарить звезду с неба, если можно самому стать ею!</p>
      <p class="main-info__text">Подарите Вашему ребёнку обучение в нашем модельном агентстве.</p>
      <a href="../ru/model-school.php" class="main-info__link">Подробнее о школе &rarr;</a><br>
      <a href="../ru/contacts.php" class="main-info__link">Связаться с нами&rarr;</a>


    </div> -->
    <div class="odri-contest">
      <div class="contest-info">
        <div class="contest-textinfo">
        ...
        <div class="contest-photo">
          <img src="../src/img/contest/modelOfJanuary.png" alt="" class="contest-photo__crownimg">
        </div>
      ...
      <div class="minimiss-photos">
        ...
        <div class="minimiss-photos__section">
         <img src="../src/img/contest/skakun.jpg" alt="" class="minimiss-photos__img">    </div>
        <div class="minimiss-photos__section">
         <img src="../src/img/contest/skorobogach.jpg" alt="" class="minimiss-photos__img">
         </div>
      </div>
      <div class="polesection"><iframe src="https://docs.google.com/forms/d/e/1FAIpQLSeTbqUkWY2qZT0RMunHwW8OZODTxVv6oBsItQ-b9v1howcMjw/viewform?embedded=true" width="500" height="750" frameborder="0" marginheight="0" marginwidth="0">Загрузка...</iframe></div>
    </div>
