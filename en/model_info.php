    ...
    <main>
        ...
        <section class="model-profile">
          <div class="model-info">
            <h2 class="model-info__name">Cara D.</h2>
            <div class="options">
              ...
              <ul class="option-values">
                <li class="option-values__value">170cm</li>
                <li class="option-values__value">85cm</li>
                <li class="option-values__value">60cm</li>
                <li class="option-values__value">90cm</li>
                <li class="option-values__value">38</li>
                <li class="option-values__value">blonde</li>
                <li class="option-values__value">blue</li>
              </ul>
            </div>
          </div>
          <div class="model-photos">
            <div class="photos-fullsize">
              <img src="../src/img/women/cara/092016-cara-delevigne-lead.jpg" alt="" class="photos-fullsize__photo">
              <img src="../src/img/women/cara/313f8182bb14072efd7875c1067ca5dc--role-models-cara-delevinge.jpg" alt="" class="photos-fullsize__photo">
              <img src="../src/img/women/cara/6229a9ce589cbb7dbe671b1a3292f078.jpg" alt="" class="photos-fullsize__photo">
              <img src="../src/img/women/cara/721ca9b135c6ba4cdaa460ee685a303e--cara-delevingne-hair-cara-delevinge.jpg" alt="" class="photos-fullsize__photo">
              <img src="../src/img/women/cara/AVG0RQe.jpg" alt="" class="photos-fullsize__photo">
              <img src="../src/img/women/cara/gallery-1470147228-elle-september-cara-delevingne-02-1.jpg" alt="" class="photos-fullsize__photo">
            </div>
          </div>
          <div class=""></div>
